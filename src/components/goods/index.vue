<template>
	<div class="good-box">
			...
			<div class="menu-wrapper" ref="menuWrapper">
				<ul>
					<li v-for="(item,$index) in goods" class="menu-item" @click="selectMenu($index,$event)" :class="{'current':currentIndex===$index}">
						<span class="text border-1px border-bottom">
			...
			<div class="foods-wrapper" ref="foodsWrapper">
				<ul>
					<li v-for="item in goods" class="food-list food-list-hook">
						...
						<ul>
							<li v-for="food in item.foods" class="food-item border-1px border-bottom" @click="selectFood(food,$event)">
								<div class="icon">
		...
		<food :food="selectedFood" ref="food" v-on:cardadd="_drop"></food>
	</div>
</template>
...
@import './../../common/scss/common/mixin';
.goods {
	display: flex;
	position: absolute;
	top: 174px;
